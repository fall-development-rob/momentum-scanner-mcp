  ...
  inputSchema: {
    ...
    properties: {
      ...
      timeframes: {
        type: 'array',
        items: { type: 'string' },
        description: 'Timeframes to analyze (e.g., ["1h", "4h", "1d"])',
      },
      config: {
        type: 'object',
        description: 'Optional configuration for indicators',
        properties: {
          includeRSI: { type: 'boolean', description: 'Include RSI indicator' },
          rsiPeriod: { type: 'number', description: 'RSI period (default: 14)' },
          includeMACD: { type: 'boolean', description: 'Include MACD indicator' },
          includeVolume: { type: 'boolean', description: 'Include volume analysis' },
        },
      },
    },
    required: ['symbol'],
...
// Re-export MomentumScanInput for convenience
export { MomentumScanInput };
